...
const items = [
  { src: "/images/feat-01.png", title: "Midnight Swan", subtitle: "Alta Costura" },
  { src: "/images/feat-2.png", title: "Olive Peplum", subtitle: "Ready to Wear" },
  { src: "/images/feat-3.jpg", title: "Metallic Flora", subtitle: "Coleccion Gala" },
  { src: "/images/feat-4.jpg", title: "Royal Sapphire", subtitle: "Edicion Limitada" },
  { src: "/images/feat-5.jpg", title: "Ivory Rustique", subtitle: "Clasicos" },
];
...
export default function FeaturedCollection() {
  ...
  return (
    <section ref={ref} style={{ backgroundColor: "#050505", color: "#fff", paddingTop: "100px", paddingBottom: "100px", overflow: "hidden" }}>
      ...
      {/* HEADER */}
      <div style={{ paddingLeft: "5vw", paddingRight: "5vw", marginBottom: "60px", display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
      ...
      {/* ===== MÓVIL: Carrusel Horizontal con Efecto Coverflow ===== */}
      <div className="md:hidden">
        <style dangerouslySetInnerHTML={{__html: `
          .feat-mobile-carousel { display: flex; overflow-x: auto; scroll-snap-type: x mandatory; gap: 12px; padding: 20px 5vw; scrollbar-width: none; }
          .feat-mobile-carousel::-webkit-scrollbar { display: none; }
          .feat-mobile-card { flex: 0 0 85vw; height: 65vh; min-height: 450px; scroll-snap-align: center; position: relative; border-radius: 8px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.5); }
        `}} />
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.2, duration: 0.8 }}>
          <div className="feat-mobile-carousel" ref={featMobileCarouselRef}>
            {items.map((item, i) => (
              <motion.div 
                key={i} 
                className="feat-mobile-card group"
      ...
      {/* ===== PC: GALERÍA DE CASCADA SIN RECORTES (Intacta) ===== */}
      <div className="hidden md:flex gap-6 px-[5vw] items-start">
      ...
      <div className="md:hidden mt-10 px-[5vw]">
